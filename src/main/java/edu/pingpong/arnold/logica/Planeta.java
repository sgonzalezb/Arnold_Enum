package edu.pingpong.arnold.logica;

import java.util.EnumSet;

public enum Planeta {

    MERCURY (3.303e+23, 2.4397e6), /// kg y radio
    ...
    public static EnumSet<Planeta> getPlanetasRocosos(){
        return EnumSet.range(MERCURY, MARS);
    }

    public static EnumSet<Planeta> getPlanetasGaseosos(){
        return EnumSet.complementOf(getPlanetasRocosos());
